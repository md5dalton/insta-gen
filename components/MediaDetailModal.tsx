...
export const MediaDetailModal: React.FC<MediaDetailModalProps> = ({
    ...
    const [selectedProfileId, setSelectedProfileId] = useState<string | null>(
        media.processingProfileId || null
    )
            ...
            <div className="w-full max-w-4xl max-h-[90vh] bg-white rounded-2xl shadow-2xl border border-slate-200 flex flex-col overflow-hidden">
                    ...
                    <div className="flex items-center gap-3 truncate pr-4">
                        ...
                        <div className="truncate">
                            ...
                            <p className="text-xs text-slate-500 truncate">
                                {media.rootCollectionName} / {media.collectionName} / @
                                {media.userName}
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex items-center px-6 border-b border-slate-200 bg-white">
                    ...
                    >
                        ...
                        {media.effectivePolicy?.missingAssets &&
                            media.effectivePolicy.missingAssets.length > 0 && (
                                ...
                                {isEffectivelyDeleted && (
                                    <div className="p-3.5 rounded-xl bg-rose-50 border border-rose-200 text-xs text-rose-800 space-y-1">
                                        ...
                                        <p className="text-rose-700">
                                            Reason:{" "}
                                            {media.effectiveDeletionSource || "Marked deleted"}.
                                            This item is waiting for filesystem cleanup and will not
                                            be permanently destroyed by the dashboard.
                                        </p>
                                    </div>
                                )}
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        <h3 className="text-base font-bold text-slate-900">
                                            {media.effectivePolicy?.profile.name ||
                                                "System Default"}
                                        </h3>
                            ...
                            {media.processingError && (
                                <div className="p-4 rounded-xl bg-rose-50 border border-rose-200 space-y-2">
                                    ...
                                    <span className="text-[10px] text-rose-500">
                                        Logged at{" "}
                                        {new Date(media.processingError.timestamp).toLocaleString()}
                                    </span>
                                </div>
                            )}
                                ...
                                <div className="divide-y divide-slate-200 rounded-xl border border-slate-200 overflow-hidden bg-white">
                                    ...
                                    <div className="p-3.5 flex items-center justify-between text-xs hover:bg-slate-50">
                                        ...
                                        <div className="flex items-center gap-3">
                                            {media.assets.some(
                                                (a) =>
                                                    a.type === "THUMBNAIL" && a.status === "READY"
                                            ) ? (
                                    ...
                                    <div className="p-3.5 flex items-center justify-between text-xs hover:bg-slate-50">
                                        <div className="flex items-center gap-3">
                                            <div
                                                className={`w-2 h-2 rounded-full ${
                                                    media.effectivePolicy?.requiredAssets.includes(
                                                        "FEED_IMAGE"
                                                    )
                                                        ? "bg-indigo-500"
                                                        : "bg-slate-300"
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[11px] text-slate-500">
                                                    Web-optimized 1080px display image
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            {media.assets.some(
                                                (a) =>
                                                    a.type === "FEED_IMAGE" && a.status === "READY"
                                            ) ? (
                                                <StatusBadge type="asset" value="READY" />
                                            ) : media.effectivePolicy?.requiredAssets.includes(
                                                  "FEED_IMAGE"
                                    ...
                                    <div className="p-3.5 flex items-center justify-between text-xs hover:bg-slate-50">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[11px] text-slate-500">
                                                    Multi-bitrate m3u8 stream playlists
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="p-3.5 flex items-center justify-between text-xs hover:bg-slate-50">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <span className="font-semibold text-slate-900">
                                                    Low-Quality Fallback (720p/480p)
                                                </span>
                                                {media.effectivePolicy?.requiredAssets.includes(
                                                    "LOW_QUALITY"
                                                ) ? (
                                                ...
                                                <p className="text-[11px] text-slate-500">
                                                    Compressed MP4 for poor connections
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            {media.assets.some(
                                                (a) =>
                                                    a.type === "LOW_QUALITY" && a.status === "READY"
                                            ) ? (
                                                <StatusBadge type="asset" value="READY" />
                                            ) : media.effectivePolicy?.requiredAssets.includes(
                                                  "LOW_QUALITY"
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 border border-slate-200">
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        <StatusBadge
                                            type="visibility"
                                            value={media.effectiveAccess?.visibility || "ALL_USERS"}
                                        />
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-xs text-slate-500">
                                        VIEW includes view + like + save. DOWNLOAD allows original
                                        file download.
                                    </span>
                                </div>

                                <div className="divide-y divide-slate-200 rounded-xl border border-slate-200 overflow-hidden bg-white">
                                    {media.effectiveAccess?.effectiveUsers.map(
                                        ({ user, allowed, blockedByParent, parentBlockReason }) => (
                                            <div
                                                key={user.id}
