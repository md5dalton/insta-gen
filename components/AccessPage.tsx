    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            Manage application users, capability profiles, and media visibility restrictions.
          </p>
        </div>
      ...
      <div className="bg-slate-950 border border-slate-800 rounded-2xl p-5 shadow-xl space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-bold text-white uppercase tracking-wider">Access Capability Architecture</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          <div className="p-3.5 rounded-xl bg-slate-900 border border-slate-800 space-y-1.5">
            ...
            <p className="text-slate-400 leading-relaxed text-[11px]">
              Users with <strong>VIEW</strong> automatically have permission to view media, like posts, and bookmark
              to collections. Separate like/save checkboxes are not required.
            </p>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-slate-900 border border-slate-800 space-y-1.5">
            ...
            <p className="text-slate-400 leading-relaxed text-[11px]">
              Additionally permits exporting or downloading the full-resolution original media file directly from the
              storage layer.
            </p>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-slate-900 border border-slate-800 space-y-1.5">
            ...
            <p className="text-slate-400 leading-relaxed text-[11px]">
              Global administrator. Automatically bypasses all media restriction policies and private visibility
              constraints.
            </p>
          </div>
        </div>
      ...
      <div className="bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden shadow-xl">
        <div className="p-4 border-b border-slate-800 flex items-center justify-between">
          <h2 className="text-xs font-bold text-slate-300 uppercase tracking-wider">Application Users ({users.length})</h2>
          <span className="text-xs text-slate-500">Configured members for access policies</span>
        </div>

        {loading ? (
          <div className="p-12 text-center text-slate-500 text-xs">Loading application users...</div>
        ) : (
                  ...
                  <tr key={u.id} className="hover:bg-slate-900/50 transition-colors">
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-1.5">
                        {u.role === 'ADMIN' ? (
                          <span className="text-indigo-400 font-semibold">Full Access (Bypass All)</span>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <label className="flex items-start gap-2.5 p-2.5 rounded-xl border border-slate-800 bg-slate-900 cursor-pointer">
                      ...
                      />
                      <div>
                        <span className="font-semibold text-slate-200 block">VIEW</span>
                    ...
                    <label className="flex items-start gap-2.5 p-2.5 rounded-xl border border-slate-800 bg-slate-900 cursor-pointer">
                      ...
                      />
                      <div>
                        <span className="font-semibold text-slate-200 block">DOWNLOAD</span>
                        <span className="text-slate-400 text-[11px] block">
                          View, like, save, plus download full-resolution original media.
                        </span>
                      </div>
                    </label>
                    ...
                    <label className="flex items-start gap-2.5 p-2.5 rounded-xl border border-slate-800 bg-slate-900 cursor-pointer">
                      ...
                      />
                      <div>
                        <span className="font-semibold text-slate-200 block">MANAGE</span>
                        <span className="text-slate-400 text-[11px] block">
                          Media management and tag administration privileges.
                        </span>
                      </div>
                    </label>
                  </div>
