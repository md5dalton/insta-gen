                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    ...
                    >
                        ...
                        <div className="flex-1">
                            ...
                            <span className="text-xs text-slate-500 block">
                                Any authenticated application user can view.
                            </span>
                        </div>
                    </button>
                    ...
                    >
                        ...
                        <div className="flex-1">
                            ...
                            <span className="text-xs text-slate-500 block">
                                Only the system administrator can access.
                            </span>
                        </div>
                    </button>
                </div>
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50/50 p-3.5 space-y-3">
                    ...
                    {parentAllowedUserIds && (
                        <div className="flex items-start gap-2 p-2.5 rounded bg-amber-50 border border-amber-200 text-xs text-amber-800">
                            ...
                            <div>
                                <strong>Inheritance Rule:</strong> A child can restrict access
                                further, but cannot bypass a parent restriction (
                                <code className="font-mono text-[11px]">parent ∩ child</code>).
                                Users blocked by {parentName || "parent"}
                    ...
                    <div className="divide-y divide-slate-200 bg-white rounded-md border border-slate-200 overflow-hidden max-h-56 overflow-y-auto">
                        {allUsers.map((user) => {
                            ...
                            const isBlockedByParent =
                                parentAllowedUserIds && !parentAllowedUserIds.includes(user.id)
