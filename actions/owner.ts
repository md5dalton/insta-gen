...
export const getUser = async (id: string): Promise<Pick<User, "id" | "name" | "picture"> | null> =>
...
export const getTagCount = async (userId: string): Promise<number> =>
