...
export async function PUT(request: any, context: any) {
  ...
  if (requiredRenditions) {
    profile.requiredRenditions = { thumbnail: true, feedImage: Boolean(requiredRenditions.feedImage), hls: Boolean(requiredRenditions.hls), lowQuality: Boolean(requiredRenditions.lowQuality) };
  }
