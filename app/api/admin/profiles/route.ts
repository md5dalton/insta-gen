...
export async function POST(request: Request) {
  ...
  db.recentActivity.unshift({ id: `act-${Date.now()}`, type: 'POLICY_CHANGE', title: 'Processing profile created', description: `Created profile "${profile.name}"`, timestamp: new Date().toISOString() });
